...
import com.cyq7on.coursehelper.ui.view.SelectRemindCyclePopup;
import com.cyq7on.coursehelper.ui.view.SelectRemindWayPopup;
import com.loonggg.lib.alarmmanager.clock.AlarmManagerUtil;

import java.text.SimpleDateFormat;
import java.util.Date;

public class SetAlarmActivity extends ParentWithNaviActivity implements View.OnClickListener{
            ...
            if (cycle == 0) {//是每天的闹钟
                ...
                for (int i = 0; i < weeks.length; i++) {
                    AlarmManagerUtil.setAlarm(this, 2, Integer.parseInt(times[0]), Integer
                            .parseInt(times[1]), i, Integer.parseInt(weeks[i]), "该上课了", ring);
                }
            }
