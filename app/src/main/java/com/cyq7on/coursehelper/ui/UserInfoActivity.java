...
//    Button btn_add_friend;
    @Bind(com.cyq7on.coursehelper.R.id.btn_publish)
    Button btn_chat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cyq7on.coursehelper.R.layout.activity_user_info);
        initNaviView();
...
//            btn_add_friend.setVisibility(View.VISIBLE);
        ...
        ImageLoaderFactory.getLoader().loadAvator(iv_avator,user.getAvatar(), com.cyq7on.coursehelper.R.mipmap.head);
...
//    }
    ...
    @OnClick(com.cyq7on.coursehelper.R.id.btn_publish)
