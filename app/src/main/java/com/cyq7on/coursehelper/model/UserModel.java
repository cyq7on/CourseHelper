package com.cyq7on.coursehelper.model;

import android.text.TextUtils;

import com.cyq7on.coursehelper.bean.Friend;
import com.cyq7on.coursehelper.bean.User;
import com.cyq7on.coursehelper.model.i.QueryUserListener;
...
public class UserModel extends BaseModel {
    ...
    public void register(String username, String password, String pwdagain, String age, int sex,
                               int role,final LogInListener listener) {
        if(TextUtils.isEmpty(username)){
            listener.internalDone(new BmobException(CODE_NULL, "请填写用户名"));
            return;
        }
