package com.cyq7on.dap.db;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.text.TextUtils;

import com.cyq7on.dap.Config;
import com.cyq7on.dap.bean.User;
import com.cyq7on.dap.db.dao.DaoMaster;
import com.cyq7on.dap.db.dao.NewFriendDao;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

import com.cyq7on.dap.db.dao.DaoSession;
